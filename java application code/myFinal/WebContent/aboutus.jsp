		...
		<div class="container">
			...
			<div class="inner_w3l_agile_grids">
				<div id="horizontalTab">
						...
						<li>
							<img src="images/mokshitsmall.jpg" alt=" " class="img-responsive" />
						</li>
						
						<li>
							<img src="images/neelsmall.jpg" alt=" " class="img-responsive" />
						</li>
						</ul>
						<div class="resp-tabs-container">
							<div class="tab1">
								...
								<div class="w3_agileits_social_media team_agile_w3l">
										<ul class="social-icons3">
											...
											<li><a href="#" class="wthree_facebook"> <i style="margin-top: 8px;" class="fa fa-facebook" aria-hidden="true"></i></a></li>
							...
							<div class="col-md-6 team-img-w3-agile">
								...
								<div class="col-md-6 team-Info-agileits">
									...
									<p>Qualification :- BScIT</p>
									<p>Phone no :- 9426930551</p>
									<p>E-mail :- <a href="mailto:mokshitshah2015@gmail.com">mokshitshah2015@gmail.com</a></p>	
								<div class="w3_agileits_social_media team_agile_w3l">
										<ul class="social-icons3">
											<li class="agileinfo_share">Follow In</li>
											<li><a href="#" class="wthree_facebook"> <i style="margin-top: 8px;" class="fa fa-facebook" aria-hidden="true"></i></a></li>
											<li><a href="https://twitter.com/mokshitshah2015" class="wthree_twitter"><i style="margin-top :8px;" class="fa fa-twitter" aria-hidden="true"></i></a></li>
											<li><a href="https://www.instagram.com/mokshitshah2015/" class="wthree_dribbble"><i  style="margin-top: 8px;" class="fa fa-instagram" aria-hidden="true"></i></a></li>
											<li><a href="https://www.linkedin.com/in/mokshit-shah-92b66b128/" class="wthree_behance"><i style="margin-top: 8px;" class="fa fa-linkedin" aria-hidden="true"></i></a></li>
										</ul>
									</div>									
								</div>
								<div class="clearfix"> </div>
							...
							<div class="col-md-6 team-img-w3-agile">
								...
								<div class="col-md-6 team-Info-agileits">
									<h4>Neel Thakkar</h4>
									<span>Developer</span>
									<p>"But active programming Consists of the design of new programs, rather than Contaplation of old program." </p>
									
									<p>Qualification :- BScIT</p>
									<p>Phone no :- 8733942898</p>
									<p>E-mail :- <a href="mailto:mrdrasticthakkar@gmail.com">mrdrasticthakkar@gmail.com</a></p>
									<div class="w3_agileits_social_media team_agile_w3l">
										<ul class="social-icons3">
											<li class="agileinfo_share">Follow In</li>
											<li><a href="#" class="wthree_facebook"> <i style="margin-top: 8px;" class="fa fa-facebook" aria-hidden="true"></i></a></li>
											<li><a href="https://twitter.com/mrdrastic2898" class="wthree_twitter"><i style="margin-top :8px;" class="fa fa-twitter" aria-hidden="true"></i></a></li>
											<li><a href="https://www.instagram.com/mr.drastic/" class="wthree_dribbble"><i  style="margin-top: 8px;" class="fa fa-instagram" aria-hidden="true"></i></a></li>
											<li><a href="https://www.linkedin.com/in/neel-thakkar-84b477128/" class="wthree_behance"><i style="margin-top: 8px;" class="fa fa-linkedin" aria-hidden="true"></i></a></li>
										</ul>
									</div>				
								</div>
								<div class="clearfix"> </div>
